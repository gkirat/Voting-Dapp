...
const contractAdd = "0x600596e684a07ba2c9c6840cbc1c1Bf6247b97C7";
    ...
    <div className="w-[50%] bg-slate-50 h-[90%] flex flex-col justify-center items-center flex-wrap dark:bg-slate-800 ">
        <div className="grid grid-rows-2 grid-flow-col w-[50%] ">
            ...
            <div className="bg-yellow md:w-[90%] text-left ">
                <p className="font-extralight dark:text-white">A deccentralized Polling system for electing candidates in the 
                election, build complelety using <span className="font-bold ">Blockchain Technology</span>. </p>
            </div>
        </div>
    </div>
